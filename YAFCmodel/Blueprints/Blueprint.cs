...
namespace YAFC.Blueprints {
    ...
    public class BlueprintEntity {
        ...
        private void ConnectSingle(BlueprintEntity other, bool red = true, bool secondPort = false, bool targetSecond = false) {
            ...
            BlueprintConnectionPoint port = secondPort
                ? connections.p2 ?? (connections.p2 = new BlueprintConnectionPoint())
                : connections.p1 ?? (connections.p1 = new BlueprintConnectionPoint());
            List<BlueprintConnectionData> list = red ? port.red : port.green;
