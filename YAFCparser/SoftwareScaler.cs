...
namespace YAFC.Parser {
    internal static class SoftwareScaler {
        public static unsafe IntPtr DownscaleIcon(IntPtr surface, int targetSize) {
            ...
            IntPtr targetSurface = SDL.SDL_CreateRGBSurfaceWithFormat(0, targetSize, targetSize, 0, format);
            ref SDL.SDL_Surface targetSurfaceData = ref RenderingUtils.AsSdlSurface(targetSurface);
