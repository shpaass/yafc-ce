...
namespace YAFC.UI {
    public static class IconCollection {
        ...
        static IconCollection() {
            ...
            Icon iconId = Icon.None + 1;
            while (iconId != Icon.FirstCustom) {
                IntPtr surface = SDL_image.IMG_Load("Data/Icons/" + iconId + ".png");
                IntPtr surfaceRgba = SDL.SDL_CreateRGBSurfaceWithFormat(0, IconSize, IconSize, 0, SDL.SDL_PIXELFORMAT_RGBA8888);
        ...
        public static Icon AddIcon(IntPtr surface) {
            ...
            ref SDL.SDL_Surface surfaceData = ref RenderingUtils.AsSdlSurface(surface);
            if (surfaceData.w == IconSize && surfaceData.h == IconSize) {
                icons.Add(surface);
            }
            else {
                IntPtr blit = SDL.SDL_CreateRGBSurfaceWithFormat(0, IconSize, IconSize, 0, SDL.SDL_PIXELFORMAT_RGBA8888);
